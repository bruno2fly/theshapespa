...
(function ($) {
    ...
    $(document).ready(function () {
       ...
       if ($('.gallery-wrap').length) {
        ...
        // Promo popup
        var $promoPopup = $('#promo-popup');
        if ($promoPopup.length) {
            var storageKey = 'promoPopupDismissed';

            var showPopup = function() {
                $promoPopup.addClass('is-visible').attr('aria-hidden', 'false');
            };

            var hidePopup = function() {
                $promoPopup.removeClass('is-visible').attr('aria-hidden', 'true');
                try {
            ...
            $promoPopup.on('click', '.promo-popup-close', function(e) {
                e.preventDefault();
                hidePopup();
            });

            // Close when clicking on the dark background
            $promoPopup.on('click', function(e) {
                if ($(e.target).is('#promo-popup')) {
                    hidePopup();
                }
            });
        }
